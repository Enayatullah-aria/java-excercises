package kapitel_01.aufgabe_08_von_1_6;

import kapitel_01.aufgabe_04.Punkt;
...
public class MethodenParameter {
    ...
    public static void methode3(Punkt x) {
        x  = new Punkt(-1.0,-1.0);
        System.out.println("Wert der lokalen Variable x vom Typ: " + x);
    }
...
// Die Methode anzeige() der Klasse Punkt wird aufgerufen
        ...
        methode2(p, parray);
        System.out.print("Die Referenzvariable vom Typ Punkt zeigt" + " nach dem Aufruf von methode2() auf das gleiche Objekt"
        ...
        System.out.println();
        System.out.print("Die Referenzvariable vom Typ Punkt zeigt" +" vor dem Aufruf von methode3() auf das Objekt: ");
        p.anzeige();
        methode3(p);
